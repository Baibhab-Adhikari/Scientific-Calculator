    ...
    while calculation:
        ...
        # arithmetic operations
            ...
            while operation not in ["A", "B", "C", "D"]:
                operation = input(
                    "Choose any of the above, (enter a,b,c, or d): "
                ).upper()
            # addition
            if operation == "A":
        ...
        # trigonometry operations
            ...
            while operation not in ["A", "B", "C", "D", "E", "F"]:
                operation = input(
                    "Choose any of the above, (enter a,b,c, d, e, or f): "
                ).upper()
            if operation == "A":
        ...
        # power/exponent operations
            ...
            while operation not in ["A", "B", "C"]:
                operation = input(
                    "Choose any of the above, (enter a,b, or c): "
                ).upper()
            if operation == "A":
